...
import { appColor, HeaderHeigth, blackColor, newColour, BlueColor, ratio,greenColor,redColor ,fontGrey} from '../constent';
...
<View >
    ...
    <Text style={{justifyContent:'flex-end',paddingEnd:10*ratio,color:greenColor,paddingTop:5*ratio}}> ^ {parseFloat(item.percentage).toFixed(2)}</Text>
                ...
                <View style={{ alignItems: "center", marginTop: 80 * ratio }}>

                    <TouchableOpacity onPress={() => this.props.navigation.navigate('Addcurrency')}>
